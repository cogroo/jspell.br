...
#Gera em Latex tabelas de conjungação verbal a partir do Jspell
...
#on makefile
#cat port.geral.dic |grep '/#v' |perl -npe 's/([^\/]+).*/$1/' |xargs
...
my $tit="Tabelas de conjugação de verbos
